...
def dgc_loss(input: Tensor, target: Tensor, mask_diagonal: Tensor = None, k: float = 1e-2, penalize: bool = False, normalize: bool = True, indicator_function: Callable = sigmoid, similarity: Callable = CosineSimilarityMatrix()) -> Tensor:
